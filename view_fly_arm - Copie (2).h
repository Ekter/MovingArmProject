...
class view_fly_arm : public QMainWindow
{
	...
	private:
		...
		void timer_define_function_execute(void);

		void no_hils_mode_manual_thrust_command_function(void);
		void controller_step_and_no_hils_mode_manual_thrust_command_function(void);
		void no_hils_mode_real_angle_no_hils_mode_1(void);
		void (*ptr_functions)(void);
